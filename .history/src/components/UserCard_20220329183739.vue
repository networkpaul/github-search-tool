    ...
    <div class="userCard-container">
        <div class="userCard-userInfo">
            ...
            <div class="userInfo-all">
                ...
                <h5 class="userInfo-userlink">@{{ user.login }}</h5>
        ...
        <div class="userCard-others">
            ...
            <LineInfosUser class="userCard-line" :data="user.blog" :image="require('@/assets/icon-website.svg')" />
...
@media (min-width: 750px) {
    ...
    .userCard-others:nth-child(1) { order: 1; }
    .userCard-others:nth-child(2) { background-color: red; }
    .userCard-others:nth-child(3) { order: 2; }
    .userCard-others:nth-child(4) { order: 4; }
